...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Guest.arrival'
        db.add_column('guest', 'arrival',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Guest.departure'
        db.add_column('guest', 'departure',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Guest.arrival'
        db.delete_column('guest', 'arrival')

        # Deleting field 'Guest.departure'
        db.delete_column('guest', 'departure')
