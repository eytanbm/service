...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.initiator'
        db.add_column('ticket', 'initiator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='initiated_tickets', to=orm['service_calls.TicketRole']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.initiator'
        db.delete_column('ticket', 'initiator_id')
