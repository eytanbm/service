...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.planned_start'
        db.add_column('ticket', 'planned_start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ticket.actual_start'
        db.add_column('ticket', 'actual_start',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ticket.actual_end'
        db.add_column('ticket', 'actual_end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.planned_start'
        db.delete_column('ticket', 'planned_start')

        # Deleting field 'Ticket.actual_start'
        db.delete_column('ticket', 'actual_start')

        # Deleting field 'Ticket.actual_end'
        db.delete_column('ticket', 'actual_end')
    ...
    models = {
        ...
        'service_calls.ticket': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initiator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'initiated_tickets'", 'to': "orm['service_calls.TicketRole']"}),
        ...
        'service_calls.ticketevent': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 5, 0, 0)'})
        },
