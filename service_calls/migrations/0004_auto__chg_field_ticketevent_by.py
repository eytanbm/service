...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TicketEvent.by'
        db.alter_column('ticket_event', 'by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TicketEvent.by'
        raise RuntimeError("Cannot reverse this migration. 'TicketEvent.by' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'TicketEvent.by'
        db.alter_column('ticket_event', 'by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
