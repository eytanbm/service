...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TicketComment.timestamp'
        db.alter_column('ticket_comment', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'TicketComment.timestamp'
        db.alter_column('ticket_comment', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'service_calls.ticketevent': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 6, 16, 0, 0)'})
        },
