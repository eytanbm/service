...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('file', (
            ...
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['service_calls.Ticket'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('service_calls', ['TicketFile'])
    ...
    models = {
        ...
        'service_calls.ticketevent': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 8, 25, 0, 0)'})
        },
        'service_calls.ticketfile': {
            'Meta': {'object_name': 'TicketFile', 'db_table': "'file'"},
            'file': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ticket': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'files'", 'to': "orm['service_calls.Ticket']"})
        },
