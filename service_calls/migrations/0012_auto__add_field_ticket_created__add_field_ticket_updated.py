...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ticket', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 7, 4, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Ticket.updated'
        db.add_column('ticket', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 7, 4, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.created'
        db.delete_column('ticket', 'created')

        # Deleting field 'Ticket.updated'
        db.delete_column('ticket', 'updated')
