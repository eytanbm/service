...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TicketAttrChange.value'
        db.delete_column('ticket_event_attribute', 'value')

        # Adding field 'TicketAttrChange.from_value'
        db.add_column('ticket_event_attribute', 'from_value',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=120),
                      keep_default=False)

        # Adding field 'TicketAttrChange.to_value'
        db.add_column('ticket_event_attribute', 'to_value',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=120),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TicketAttrChange.value'
        raise RuntimeError("Cannot reverse this migration. 'TicketAttrChange.value' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'TicketAttrChange.value'
        db.add_column('ticket_event_attribute', 'value',
                      self.gf('django.db.models.fields.CharField')(max_length=120),
                      keep_default=False)

        # Deleting field 'TicketAttrChange.from_value'
        db.delete_column('ticket_event_attribute', 'from_value')

        # Deleting field 'TicketAttrChange.to_value'
        db.delete_column('ticket_event_attribute', 'to_value')
    ...
    models = {
        ...
        'service_calls.ticketevent': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 8, 0, 0)'})
        },
