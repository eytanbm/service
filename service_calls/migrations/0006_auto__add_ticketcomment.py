...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ticket_comment', (
            ...
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['service_calls.Ticket'])),
            ('commentor', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comments', null=True, to=orm['service_calls.TicketRole'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 9, 0, 0))),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('service_calls', ['TicketComment'])
