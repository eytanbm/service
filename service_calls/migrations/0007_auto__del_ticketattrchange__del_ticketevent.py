...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('ticket_event_attribute', (
            ...
            ('to_value', self.gf('django.db.models.fields.CharField')(default='None', max_length=120)),
            ('from_value', self.gf('django.db.models.fields.CharField')(default='None', max_length=120)),
        ...
        db.create_table('ticket_event', (
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 9, 0, 0))),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='history', to=orm['service_calls.Ticket'])),
            ('by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
    ...
    models = {
        ...
        'service_calls.ticketcomment': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 5, 9, 0, 0)'})
        },
